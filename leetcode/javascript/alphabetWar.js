...
There are two groups of hostile letters. The
tension between left side letters and right side
...
function alphabetWar(fight){
    ...
    for (var i = 0; i < fight.length; i++){
        if (rightSide[fight.charAt(i)] !== undefined){
            score += rightSide[fight.charAt(i)];
        } else if (leftSide[fight.charAt(i)] !== undefined){
            score -= leftSide[fight.charAt(i)];
        }
    }
