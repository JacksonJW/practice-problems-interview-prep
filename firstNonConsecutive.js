...
then 1 then 2 then 3 then 4 are all
consecutive but 6 is not, so that's
...
elements and all the elements will be
numbers. The numbers will also all be
unique and in ascending order. The numbers
